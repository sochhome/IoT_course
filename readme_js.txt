...
Github sochhome/testBinder

Binder for python notebook  
https://notebooks.gesis.org/binder/jupyter/user/sochhome-testbinder-y8l1cyxg/lab

https://itsfoss.com/vs-code-github/

https://www.youtube.com/watch?v=mR9jhYD3bnI

In VS Code, one-by-one INstall extenisons 1) GitHub Repositories, 2) GitHub Pull Requests and 3) GitHub Codespaces
==> 
Completed installing GitHub Codespaces extension from VSIX.

Remote Explorer --> Open Remote Repository --> Open Repository from GitHub <Eeter> --> login -->
